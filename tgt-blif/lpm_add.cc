...
int print_lpm_add(FILE* fd, ivl_lpm_t net) {
    ...
    for (unsigned idx = 1; idx < ivl_lpm_width(net); idx += 1) {
        char cin[128];
        snprintf(cin, sizeof cin, "%s%s/cout", q_ned->get_name(), q_ned->get_name_index(idx - 1));
