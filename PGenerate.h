...
//      PGenerate*parent;
	...
	// These are the scopes created by generate_scope, keyed by
	// the container scope that holds each generated scope so
	// that elaboration can find the scopes for one container
	// without scanning the scopes generated for every other
	// instance of this scheme. Equal keys preserve insertion
	// order, so per-container elaboration order is unchanged.
      std::multimap<const NetScope*,NetScope*>scope_list_;
