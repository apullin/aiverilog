...
class netclass_t : public ivl_type_s {
  public:
    ...
    inline const NetScope* class_scope(void) const {
        return class_scope_;
    }
    ...
    inline const netclass_t* get_super() const {
        return super_;
    }
    ...
    const NetExpr* get_parameter(Design* des, perm_string name, ivl_type_t& par_type) const;

    void set_virtual(bool virtual_class) {
        virtual_class_ = virtual_class;
    }
    bool is_virtual() const {
        return virtual_class_;
    }
