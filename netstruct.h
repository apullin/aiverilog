...
class netstruct_t : public LineInfo, public ivl_type_s {
  ...
  public:
    ...
    bool get_signed(void) const override {
        return signed_;
    }
    ...
    const std::vector<member_t>& members() const {
        return members_;
    }
...
inline bool netstruct_t::union_flag(void) const {
    return union_;
}
inline bool netstruct_t::packed(void) const {
    return packed_;
}
