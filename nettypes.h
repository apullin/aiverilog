...
class netarray_t : public ivl_type_s {
  ...
  public:
    inline ivl_type_t element_type() const {
...
class netrange_t {
  public:
    ...
    // Copy constructor.
    inline netrange_t(const netrange_t& that) : msb_(that.msb_), lsb_(that.lsb_) {}
...
extern unsigned long netrange_width(const netranges_t& dims, unsigned int base_width = 1);
 ...
 */
extern bool calculate_param_range(
