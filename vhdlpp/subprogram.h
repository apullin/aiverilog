...
class SubprogramBody : public LineInfo, public ScopeBase {
  public:
    ...
    bool is_subprogram() const override {
        return true;
    }
...
class SubprogramHeader : public LineInfo {
  public:
    SubprogramHeader(perm_string name, std::list<InterfacePort*>* ports, const VType* return_type);
    ...
    virtual int
    emit_name(const std::vector<Expression*>& argv, std::ostream& out, Entity*, ScopeBase*) const;
    ...
    virtual int
    emit_args(const std::vector<Expression*>& argv, std::ostream& out, Entity*, ScopeBase*) const;
    ...
    SubprogramHeader* make_instance(const std::vector<Expression*>& arguments,
...
class SubprogramStdHeader : public SubprogramHeader {
  public:
    SubprogramStdHeader(perm_string nam, std::list<InterfacePort*>* ports, const VType* return_type)
