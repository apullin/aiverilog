...
extern const VType* calculate_subtype_range(const YYLTYPE& loc,
                                            const char* base_name,
                                            ScopeBase* scope,
...
extern void library_use(
    const YYLTYPE& loc, ActiveScope* res, const char* libname, const char* pack, const char* ident);
