...
class NetObj : public NetPins, public Attrib {
  public:
    ...
    void rename(perm_string n) {
        name_ = n;
    }

    const NetExpr* rise_time() const {
        return delay1_;
    }
    const NetExpr* fall_time() const {
        return delay2_;
    }
    const NetExpr* decay_time() const {
        return delay3_;
    }

    void rise_time(const NetExpr* d) {
        delay1_ = d;
    }
    void fall_time(const NetExpr* d) {
        delay2_ = d;
    }
    void decay_time(const NetExpr* d) {
        delay3_ = d;
    }
...
inline void connect(Nexus* l, Link& r) {
    l->connect(r);
}
...
class NexusSet {
  ...
  public:
    ...
    inline elem_t& operator[](unsigned idx) {
        return at(idx);
    }
...
class NetDelaySrc : public NetObj {
  public:
    explicit NetDelaySrc(NetScope* s,
                         perm_string n,
                         unsigned nsrc,
                         bool condit_src,
                         bool conditional,
    ...
    void
    set_delays(uint64_t t01, uint64_t t10, uint64_t t0z, uint64_t tz1, uint64_t t1z, uint64_t tz0);
    void set_delays(uint64_t t01,
                    uint64_t t10,
                    uint64_t t0z,
                    uint64_t tz1,
                    uint64_t t1z,
...
class NetNet : public NetObj, public PortType {
  ...
  public:
    ...
    explicit NetNet(
        NetScope* s, perm_string n, Type t, const netranges_t& unpacked, ivl_type_t type);
    ...
    bool coerced_to_uwire() {
        return coerced_to_uwire_;
    }
    ...
    inline const ivl_type_s* net_type(void) const {
        return net_type_;
    }
    ...
    inline unsigned long vector_width() const {
        return slice_width(0);
    }
    ...
    inline unsigned unpacked_dimensions() const {
        return unpacked_dims_.size();
    }

    /* This method returns 0 for scalars, but vectors and other
       PACKED arrays have packed dimensions. */
    inline size_t packed_dimensions() const {
        return slice_dims_.size();
    }

    // This is the number of array elements.
    unsigned unpacked_count() const;

    bool local_flag() const {
        return local_flag_;
    }
    void local_flag(bool f) {
        local_flag_ = f;
    }
...
class NetBaseDef {
  public:
    NetBaseDef(NetScope* n, const std::vector<NetNet*>& po, const std::vector<NetExpr*>& pd);
    virtual ~NetBaseDef();
...
class NetScope : public Definitions, public Attrib {
  public:
    ...
    struct range_t;
    void set_parameter(perm_string name,
                       bool is_annotatable,
                       const LexicalScope::param_expr_t& param,
                       NetScope::range_t* range_list);
    void set_parameter(perm_string name, NetExpr* val, const LineInfo& file_line);

    const NetExpr* get_parameter(Design* des, const char* name, ivl_type_t& ivl_type);
    const NetExpr* get_parameter(Design* des, perm_string name, ivl_type_t& ivl_type);
    ...
    void replace_parameter(
        Design* des, perm_string name, PExpr* val, NetScope* scope, bool defparam = false);
    ...
    inline bool nested_module() const {
        return nested_module_;
    }
    // Program blocks and interfaces have elaboration constraints.
    inline bool program_block() const {
    ...
    void set_var_init(const NetProc* proc) {
        var_init_ = proc;
    }
    const NetProc* var_init() const {
        return var_init_;
    }
    ...
    void set_line(perm_string file, perm_string def_file, unsigned lineno, unsigned def_lineno);
    void set_line(perm_string file, unsigned lineno);
    void set_line(const LineInfo* info);
    perm_string get_file() const {
        return file_;
    };
    perm_string get_def_file() const {
        return def_file_;
    };
    unsigned get_lineno() const {
        return lineno_;
    };
    unsigned get_def_lineno() const {
        return def_lineno_;
    };
    ...
    /* Provide a link back to the pform to allow early elaboration of
         constant functions. */
    void set_func_pform(const PFunction* pfunc) {
        func_pform_ = pfunc;
    };
    const PFunction* func_pform() const {
        return func_pform_;
    };
    ...
    */
    void set_elab_stage(unsigned stage) {
        elab_stage_ = stage;
    };
    unsigned elab_stage() const {
        return elab_stage_;
    };

    /* Is this a function called in a constant expression. */
    void need_const_func(bool need_const) {
        need_const_func_ = need_const;
    };
    bool need_const_func() const {
        return need_const_func_;
    };

    /* Is this a constant function. */
    void is_const_func(bool is_const) {
        is_const_func_ = is_const;
    };
    bool is_const_func() const {
        return is_const_func_;
    };

    /* Is the task or function automatic. */
    void is_auto(bool is_auto__) {
        is_auto_ = is_auto__;
    };
    bool is_auto() const {
        return is_auto_;
    ...
    void calls_sys_task(bool calls_stask__) {
        calls_stask_ = calls_stask__;
    };
    bool calls_sys_task() const {
        return calls_stask_;
    };

    /* Is this scope elaborating a final procedure? */
    void in_final(bool in_final__) {
        in_final_ = in_final__;
    };
    bool in_final() const {
        return in_final_;
    };
    ...
    Link& tie_hi() const {
        return tie_hi_->pin(0);
    };
    Link& tie_lo() const {
        return tie_lo_->pin(0);
    };
...
class NetConcat : public NetNode {
  public:
    NetConcat(
        NetScope* scope, perm_string n, unsigned wid, unsigned cnt, bool transparent_flag = false);
    ~NetConcat() override;
...
class NetDivide : public NetNode {
  public:
    NetDivide(NetScope* scope, perm_string n, unsigned width, unsigned wa, unsigned wb);
    ~NetDivide() override;
...
class NetModulo : public NetNode {
  public:
    NetModulo(NetScope* s, perm_string n, unsigned width, unsigned wa, unsigned wb);
    ~NetModulo() override;
...
class NetMult : public NetNode {
  public:
    NetMult(NetScope* sc, perm_string n, unsigned width, unsigned wa, unsigned wb);
    ~NetMult() override;
...
class NetMux : public NetNode {
  public:
    NetMux(NetScope* scope, perm_string n, unsigned width, unsigned size, unsigned selw);
    ~NetMux() override;
...
class NetTran : public NetNode, public IslandBranch {
  public:
    ...
    // Create a TRAN_VP
    NetTran(NetScope* scope, perm_string n, unsigned wid, unsigned part, unsigned off);
    ~NetTran() override;

    ivl_switch_type_t type() const {
        return type_;
    }
...
class NetExpr : public LineInfo {
  public:
    ...
    virtual NexusSet*
    nex_input(bool rem_out = true, bool always_sens = false, bool nested_func = false) const = 0;
  ...
  protected:
    void expr_width(unsigned wid) {
        width_ = wid;
    }
    void cast_signed_base_(bool flag) {
        signed_flag_ = flag;
    }
...
class NetEArrayPattern : public NetExpr {
  public:
    ...
    const NetExpr* item(size_t idx) const {
        return items_[idx];
    }
...
class NetEConstEnum : public NetEConst {
  public:
    explicit NetEConstEnum(perm_string name, const netenum_t* enum_set, const verinum& val);
...
class NetEConstParam : public NetEConst {
  public:
    explicit NetEConstParam(const NetScope* scope, perm_string name, const verinum& val);
...
class NetECRealParam : public NetECReal {
  public:
    explicit NetECRealParam(const NetScope* scope, perm_string name, const verireal& val);
...
class NetPartSelect : public NetNode {
  public:
    ...
    explicit NetPartSelect(
        NetNet* sig, unsigned off, unsigned wid, dir_t dir, bool signed_flag__ = false);
    explicit NetPartSelect(NetNet* sig, NetNet* sel, unsigned wid, bool signed_flag__ = false);
    ~NetPartSelect() override;

    unsigned base() const;
    unsigned width() const;
    inline dir_t dir() const {
        return dir_;
    }
    /* Is the select signal signed? */
    inline bool signed_flag() const {
        return signed_flag_;
    }
...
class NetBUFZ : public NetNode {
  public:
    explicit NetBUFZ(
        NetScope* s, perm_string n, unsigned wid, bool transp, int port_info_index = -1);
    ~NetBUFZ() override;
    ...
    int port_info_index() const {
        return port_info_index_;
    }
...
class NetConst : public NetNode {
  public:
    ...
    inline const verinum& value(void) const {
        return value_;
    }
...
class NetLogic : public NetNode {
  public:
    ...
    explicit NetLogic(
        NetScope* s, perm_string n, unsigned pins, TYPE t, unsigned wid, bool is_cassign__ = false);
...
class NetUDP : public NetNode {
  public:
    ...
    perm_string udp_name() const {
        return udp->name_;
    }
    perm_string udp_file() const {
        return udp->get_file();
    }
    unsigned udp_lineno() const {
        return udp->get_lineno();
    }
...
class NetProc : public virtual LineInfo {
  public:
    ...
    // sensitivity list.
    virtual NexusSet*
    nex_input(bool rem_out = true, bool always_sens = false, bool nested_func = false) const;
    ...
    virtual bool evaluate_function(const LineInfo& loc, std::map<perm_string, LocalVar>& ctx) const;
    ...
    virtual bool synth_async(Design* des,
                             NetScope* scope,
                             NexusSet& nex_map,
                             NetBus& nex_out,
                             NetBus& enables,
    ...
    virtual bool synth_sync(Design* des,
                            NetScope* scope,
                            bool& ff_negedge,
                            NetNet* ff_clock,
                            NetBus& ff_ce,
  ...
  protected:
    bool synth_async_block_substatement_(Design* des,
                                         NetScope* scope,
                                         NexusSet& nex_map,
                                         NetBus& nex_out,
                                         NetBus& enables,
...
class NetAssign_ {
  public:
    ...
    inline int get_property_idx(void) const {
        return member_idx_;
    }
    ...
    NetNet* sig() const;
    inline const NetAssign_* nest() const {
        return nest_;
    }
...
class NetAssign : public NetAssignBase {
  public:
    ...
    inline char assign_operator(void) const {
        return op_;
    }
  ...
  private:
    ...
    bool eval_func_lval_(const LineInfo& loc,
                         std::map<perm_string, LocalVar>& ctx,
...
class NetAssignNB : public NetAssignBase {
  public:
    explicit NetAssignNB(NetAssign_* lv, NetExpr* rv, NetEvWait* ev, NetExpr* cnt);
...
class NetBreak : public NetProc {
  public:
    virtual void dump(std::ostream&, unsigned ind) const override;
    virtual bool emit_proc(struct target_t*) const override;
    bool evaluate_function(const LineInfo& loc, std::map<perm_string, LocalVar>& ctx) const final;
};
...
class NetCase : public NetProc {
  public:
    ...
    inline ivl_case_quality_t case_quality() const {
        return quality_;
    }
    TYPE type() const;
    ...
    inline unsigned nitems() const {
        return items_.size();
    }

    inline const NetExpr* expr(unsigned idx) const {
        return items_[idx].guard;
    }
  ...
  private:
    bool evaluate_function_vect_(const LineInfo& loc, std::map<perm_string, LocalVar>& ctx) const;
    bool evaluate_function_real_(const LineInfo& loc, std::map<perm_string, LocalVar>& ctx) const;

    bool synth_async_casez_(Design* des,
                            NetScope* scope,
                            NexusSet& nex_map,
                            NetBus& nex_out,
                            NetBus& enables,
...
class NetEvWait : public NetProc {
  public:
    ...
    inline void set_t0_trigger() {
        has_t0_trigger_ = true;
    };

    inline unsigned nevents() const {
        return events_.size();
    }
    inline const NetEvent* event(unsigned idx) const {
        return events_[idx];
    }
    inline NetEvent* event(unsigned idx) {
        return events_[idx];
    }
    inline bool has_t0_trigger() const {
        return has_t0_trigger_;
    };
...
class NetEvProbe : public NetNode {
  ...
  public:
    ...
    explicit NetEvProbe(NetScope* s, perm_string n, NetEvent* tgt, edge_t t, unsigned p);
    ~NetEvProbe() override;
...
class NetForLoop : public NetProc {
  public:
    explicit NetForLoop(
        NetNet* index, NetExpr* initial_expr, NetExpr* cond, NetProc* sub, NetProc* step);
    ~NetForLoop() override;
...
class NetSTask : public NetProc {
  public:
    NetSTask(const char* na, ivl_sfunc_as_task_t sfat, const std::vector<NetExpr*>&);
    ~NetSTask() override;
...
class NetTaskDef : public NetBaseDef {
  public:
    NetTaskDef(NetScope* n, const std::vector<NetNet*>& po, const std::vector<NetExpr*>& pd);
    ~NetTaskDef() override;
...
class NetEAccess : public NetExpr {
  public:
    ...
    ivl_nature_t get_nature() const {
        return nature_;
    }
    NetBranch* get_branch() const {
        return branch_;
    }
...
class NetEBinary : public NetExpr {
  public:
    ...
    const NetExpr* left() const {
        return left_;
    }
    const NetExpr* right() const {
        return right_;
    }
...
class NetESelect : public NetExpr {
  public:
    NetESelect(NetExpr* exp,
               NetExpr* base,
               unsigned wid,
               ivl_select_type_t sel_type = IVL_SEL_OTHER);
    NetESelect(NetExpr* exp, NetExpr* base, unsigned wid, ivl_type_t use_type);
    ~NetESelect() override;
...
class NetENew : public NetExpr {
  public:
    ...
    inline const NetExpr* size_expr() const {
        return size_;
    }
    inline const NetExpr* init_expr() const {
        return init_val_;
    }
...
class NetEProperty : public NetExpr {
  public:
    ...
    inline const NetNet* get_sig() const {
        return net_;
    }
    inline size_t property_idx() const {
        return pidx_;
    }
    inline const NetExpr* get_index() const {
        return index_;
    }
...
class NetESFunc : public NetExpr {
  ...
  private:
    ...
    NetExpr* evaluate_two_arg_(ID id, const NetExpr* arg0, const NetExpr* arg1) const;
    ...
    NetECReal* evaluate_math_two_arg_(ID id, const NetExpr* arg0, const NetExpr* arg1) const;

    NetExpr* evaluate_abs_(const NetExpr* arg) const;
    NetExpr* evaluate_min_max_(ID id, const NetExpr* arg0, const NetExpr* arg1) const;
    ...
    NetEConst* evaluate_array_funcs_(ID id, const NetExpr* arg0, const NetExpr* arg1) const;
    NetEConst* evaluate_countbits_(void) const;

  public:
    bool is_built_in() const {
        return built_in_id_() != NOT_BUILT_IN;
    };
...
class NetESignal : public NetExpr {
  public:
    ...
    NexusSet* nex_input(bool rem_out = true,
                        bool always_sens = false,
                        bool nested_func = false) const override;
    NexusSet* nex_input_base(
        bool rem_out, bool always_sens, bool nested_func, unsigned base, unsigned width) const;
...
class Design {
  public:
    ...
    void set_flags(const std::map<std::string, const char*>& f) {
        flags_ = f;
    }
    ...
    NetScope*
    make_root_scope(perm_string name, NetScope* unit_scope, bool program_block, bool is_interface);
    NetScope* find_root_scope();
    std::list<NetScope*>& find_root_scopes() const;

    NetScope* make_package_scope(perm_string name, NetScope* unit_scope, bool is_unit);
    ...
    NetScope*
    find_scope(NetScope*, const hname_t& name, NetScope::TYPE type = NetScope::MODULE) const;
    ...
    NetScope* find_scope(NetScope*,
                         const std::list<hname_t>& path,
  ...
  private:
    NetScope*
    find_scope_(NetScope*, const hname_t& name, NetScope::TYPE type = NetScope::MODULE) const;

    NetScope* find_scope_(NetScope*,
                          const std::list<hname_t>& path,
                          NetScope::TYPE type = NetScope::MODULE) const;
