...
static void
__compile_var_real(char* label, char* name, vvp_array_t array, unsigned long array_addr) {
...
class base_net_resolv : public resolv_list_s {
  public:
    explicit base_net_resolv(char* ref_label,
                             vvp_array_t array,
                             __vpiScope* scope,
                             char* my_label,
                             char* name,
...
class __compile_net_resolv : public base_net_resolv {
  public:
    explicit __compile_net_resolv(char* ref_label,
                                  vvp_array_t array,
                                  __vpiScope* scope,
                                  char* my_label,
                                  char* name,
...
static void do_compile_net(vvp_net_t* node,
                           vvp_array_t array,
                           __vpiScope* scope,
                           char* my_label,
                           char* name,
...
void compile_net(char* label,
                 ...
                 unsigned argc,
                 struct symb_s* argv) {
    __compile_net(label, name, 0, 0, msb, lsb, vpi_type_code, signed_flag, local_flag, argc, argv);
}

void compile_netw(char* label,
                  char* array_label,
                  unsigned long array_addr,
                  int msb,
                  int lsb,
                  ...
                  struct symb_s* argv) {
    __compile_net(
        label, 0, array_label, array_addr, msb, lsb, vpi_type_code, signed_flag, false, argc, argv);
}

class __compile_real_net_resolv : public base_net_resolv {
  public:
    explicit __compile_real_net_resolv(char* ref_label,
                                       vvp_array_t array,
                                       __vpiScope* scope,
                                       char* my_label,
                                       char* name,
...
static void __compile_real_net2(vvp_net_t* node,
                                vvp_array_t array,
                                __vpiScope* scope,
                                char* my_label,
                                char* name,
...
static void __compile_real(char* label,
                           char* name,
                           char* array_label,
                           unsigned long array_addr,
                           int msb,
...
void compile_net_real(char* label,
                      char* name,
                      int msb,
                      int lsb,
                      bool local_flag,
...
void compile_netw_real(char* label,
                       char* array_label,
                       unsigned long array_addr,
                       int msb,
                       int lsb,
                       unsigned argc,
                       struct symb_s* argv) {
    __compile_real(label, 0, array_label, array_addr, msb, lsb, false, argc, argv);
}
