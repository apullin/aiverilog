...
class vvp_island : private vvp_gen_event_s {
  public:
    ...
    virtual void count_drivers(vvp_island_port* port, unsigned bit_idx, unsigned counts[3]) = 0;
...
class vvp_island_port : public vvp_net_fun_t {
  ...
  public:  // Implement vvp_net_fun_t methods
    ...
    virtual void recv_vec4_pv(vvp_net_ptr_t port,
    ...
    virtual void
    recv_vec8_pv(vvp_net_ptr_t p, const vvp_vector8_t& bit, unsigned base, unsigned vwid) override;
