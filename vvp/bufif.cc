...
vvp_fun_bufif::vvp_fun_bufif(bool en_invert, bool out_invert, unsigned str0, unsigned str1)
...
void vvp_fun_bufif::recv_vec4(vvp_net_ptr_t ptr, const vvp_vector4_t& bit, vvp_context_t) {
    switch (ptr.port()) {
        case 0:
            bit_ = inv_ ? ~bit : bit;
            break;
...
void vvp_fun_bufif::recv_vec4_pv(
...
void vvp_fun_bufif::recv_real(vvp_net_ptr_t ptr, double real, vvp_context_t ctx) {
