const char COPYRIGHT[] = "Copyright (c) 2001-2026 Stephen Williams (steve@icarus.com)";
/*
...
int main(int argc, char* argv[]) {
    ...
    while ((opt = getopt(argc, argv, "+hil:M:m:nNqsvV")) != EOF)
        switch (opt) {
            case 'h':
                fprintf(stderr,
    ...
    if (version_flag) {
        fprintf(stderr, "Icarus Verilog runtime version " VERSION " (" VERSION_TAG ")\n\n");
        fprintf(stderr, "%s\n\n", COPYRIGHT);
        fprintf(stderr,
