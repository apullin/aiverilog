...
void vvp_fun_substitute::recv_vec4(vvp_net_ptr_t port, const vvp_vector4_t& bit, vvp_context_t) {
...
void vvp_fun_substitute::recv_vec4_pv(
...
void compile_substitute(char* label,
                        unsigned width,
                        unsigned soff,
                        unsigned swidth,
                        unsigned argc,
