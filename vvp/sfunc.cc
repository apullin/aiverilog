...
sfunc_core::sfunc_core(vvp_net_t* net, vpiHandle sys, unsigned argc, vpiHandle* argv)
 ...
 */
void sfunc_core::recv_vec4(vvp_net_ptr_t, const vvp_vector4_t& /*bit*/, vvp_context_t) {
...
static int make_vpi_argv(unsigned argc, vpiHandle* vpi_argv, const char* arg_string) {
    unsigned idx = 0;
...
void compile_sfunc(char* label,
    ...
    vpiHandle sys = vpip_build_vpi_call(name,
                                        val_code,
                                        val_width,
                                        ptr,
                                        true,
