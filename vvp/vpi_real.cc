...
static vpiHandle
vpip_make_real_(__vpiScope* scope, const char* name, vvp_net_t* net, bool is_wire) {
...
vpiHandle vpip_make_real_net(__vpiScope* scope, const char* name, vvp_net_t* net) {
