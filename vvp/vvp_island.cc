...
void vvp_island_port::recv_vec4(vvp_net_ptr_t, const vvp_vector4_t& bit, vvp_context_t) {
...
void vvp_island_port::recv_vec4_pv(
...
void vvp_island_port::recv_vec8_pv(vvp_net_ptr_t,
...
void compile_island_base(char* label, vvp_island* use_island) {
    ...
    island_count += 1;
    island_list =
        static_cast<vvp_island**>(realloc(island_list, island_count * sizeof(vvp_island**)));
