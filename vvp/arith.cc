...
vvp_arith_::vvp_arith_(unsigned wid) : wid_(wid), op_a_(wid), op_b_(wid), x_val_(wid) {
...
void vvp_arith_abs::recv_vec4(vvp_net_ptr_t ptr, const vvp_vector4_t& bit, vvp_context_t) {
...
void vvp_arith_abs::recv_vec4_pv(
    vvp_net_ptr_t ptr, const vvp_vector4_t& bit, unsigned base, unsigned vwid, vvp_context_t ctx) {
    recv_vec4_pv_(ptr, bit, base, vwid, ctx);
}
...
void vvp_arith_cast_int::recv_real(vvp_net_ptr_t ptr, double bit, vvp_context_t) {
    ptr.ptr()->send_vec4(vvp_vector4_t(wid_, bit), 0);
}

vvp_arith_cast_real::vvp_arith_cast_real(bool signed_flag) : signed_(signed_flag) {}

vvp_arith_cast_real::~vvp_arith_cast_real() {}

void vvp_arith_cast_real::recv_vec4(vvp_net_ptr_t ptr, const vvp_vector4_t& bit, vvp_context_t) {
    double val;
    vector4_to_value(bit, val, signed_);
    ptr.ptr()->send_real(val, 0);
}

void vvp_arith_cast_real::recv_vec4_pv(
    vvp_net_ptr_t ptr, const vvp_vector4_t& bit, unsigned base, unsigned vwid, vvp_context_t ctx) {
    recv_vec4_pv_(ptr, bit, base, vwid, ctx);
}
...
void vvp_arith_cast_vec2::recv_real(vvp_net_ptr_t ptr, double bit, vvp_context_t) {
    ptr.ptr()->send_vec4(vvp_vector4_t(wid_, bit), 0);
}

void vvp_arith_cast_vec2::recv_vec4(vvp_net_ptr_t ptr, const vvp_vector4_t& bit, vvp_context_t) {
    vvp_vector2_t tmp = vvp_vector2_t(bit);
    ptr.ptr()->send_vec4(vector2_to_vector4(tmp, wid_), 0);
}

void vvp_arith_cast_vec2::recv_vec4_pv(
    vvp_net_ptr_t ptr, const vvp_vector4_t& bit, unsigned base, unsigned vwid, vvp_context_t ctx) {
    recv_vec4_pv_(ptr, bit, base, vwid, ctx);
}
...
void vvp_arith_div::recv_vec4(vvp_net_ptr_t ptr, const vvp_vector4_t& bit, vvp_context_t) {
...
vvp_arith_mod::vvp_arith_mod(unsigned wid, bool sf) : vvp_arith_(wid), signed_flag_(sf) {}
...
void vvp_arith_mod::recv_vec4(vvp_net_ptr_t ptr, const vvp_vector4_t& bit, vvp_context_t) {
    dispatch_operand_(ptr, bit);
...
void vvp_arith_mult::recv_vec4(vvp_net_ptr_t ptr, const vvp_vector4_t& bit, vvp_context_t) {
    dispatch_operand_(ptr, bit);
...
void vvp_arith_pow::recv_vec4(vvp_net_ptr_t ptr, const vvp_vector4_t& bit, vvp_context_t) {
    dispatch_operand_(ptr, bit);
...
void vvp_arith_sum::recv_vec4(vvp_net_ptr_t ptr, const vvp_vector4_t& bit, vvp_context_t) {
    dispatch_operand_(ptr, bit);
 ...
 * adding a correction.
 */
void vvp_arith_sub::recv_vec4(vvp_net_ptr_t ptr, const vvp_vector4_t& bit, vvp_context_t) {
    dispatch_operand_(ptr, bit);
...
void vvp_cmp_eeq::recv_vec4(vvp_net_ptr_t ptr, const vvp_vector4_t& bit, vvp_context_t) {
    dispatch_operand_(ptr, bit);
...
void vvp_cmp_nee::recv_vec4(vvp_net_ptr_t ptr, const vvp_vector4_t& bit, vvp_context_t) {
    dispatch_operand_(ptr, bit);
 ...
 * the result is 1.
 */
void vvp_cmp_eq::recv_vec4(vvp_net_ptr_t ptr, const vvp_vector4_t& bit, vvp_context_t) {
    dispatch_operand_(ptr, bit);
 ...
 * the result is 1.
 */
void vvp_cmp_eqx::recv_vec4(vvp_net_ptr_t ptr, const vvp_vector4_t& bit, vvp_context_t) {
    dispatch_operand_(ptr, bit);
...
void vvp_cmp_eqz::recv_vec4(vvp_net_ptr_t ptr, const vvp_vector4_t& bit, vvp_context_t) {
    dispatch_operand_(ptr, bit);
 ...
 * the result is 0.
 */
void vvp_cmp_ne::recv_vec4(vvp_net_ptr_t ptr, const vvp_vector4_t& bit, vvp_context_t) {
    dispatch_operand_(ptr, bit);

    if (op_a_.size() != op_b_.size()) {
        cerr << "internal error: vvp_cmp_ne: op_a_=" << op_a_ << ", op_b_=" << op_b_ << endl;
        assert(op_a_.size() == op_b_.size());
    }
...
void vvp_cmp_gtge_base_::recv_vec4_base_(vvp_net_ptr_t ptr,
    ...
    vvp_bit4_t out = signed_flag_ ? compare_gtge_signed(op_a_, op_b_, out_if_equal)
...
vvp_cmp_ge::vvp_cmp_ge(unsigned wid, bool flag) : vvp_cmp_gtge_base_(wid, flag) {}

void vvp_cmp_ge::recv_vec4(vvp_net_ptr_t ptr, const vvp_vector4_t& bit, vvp_context_t) {
    recv_vec4_base_(ptr, bit, BIT4_1);
}

vvp_cmp_gt::vvp_cmp_gt(unsigned wid, bool flag) : vvp_cmp_gtge_base_(wid, flag) {}

void vvp_cmp_gt::recv_vec4(vvp_net_ptr_t ptr, const vvp_vector4_t& bit, vvp_context_t) {
    recv_vec4_base_(ptr, bit, BIT4_0);
}

vvp_cmp_weq::vvp_cmp_weq(unsigned wid) : vvp_arith_(wid) {}

void vvp_cmp_weq::recv_vec4(vvp_net_ptr_t ptr, const vvp_vector4_t& bit, vvp_context_t) {
    dispatch_operand_(ptr, bit);
...
void vvp_cmp_wne::recv_vec4(vvp_net_ptr_t ptr, const vvp_vector4_t& bit, vvp_context_t) {
    dispatch_operand_(ptr, bit);
...
void vvp_shiftl::recv_vec4(vvp_net_ptr_t ptr, const vvp_vector4_t& bit, vvp_context_t) {
    dispatch_operand_(ptr, bit);
...
void vvp_shiftr::recv_vec4(vvp_net_ptr_t ptr, const vvp_vector4_t& bit, vvp_context_t) {
    dispatch_operand_(ptr, bit);
...
void vvp_arith_mult_real::recv_real(vvp_net_ptr_t ptr, double bit, vvp_context_t) {
    dispatch_operand_(ptr, bit);
...
void vvp_arith_pow_real::recv_real(vvp_net_ptr_t ptr, double bit, vvp_context_t) {
    dispatch_operand_(ptr, bit);
...
void vvp_arith_div_real::recv_real(vvp_net_ptr_t ptr, double bit, vvp_context_t) {
    dispatch_operand_(ptr, bit);
...
void vvp_arith_mod_real::recv_real(vvp_net_ptr_t ptr, double bit, vvp_context_t) {
    dispatch_operand_(ptr, bit);
...
void vvp_arith_sum_real::recv_real(vvp_net_ptr_t ptr, double bit, vvp_context_t) {
    dispatch_operand_(ptr, bit);
...
void vvp_arith_sub_real::recv_real(vvp_net_ptr_t ptr, double bit, vvp_context_t) {
    dispatch_operand_(ptr, bit);
...
void vvp_cmp_eq_real::recv_real(vvp_net_ptr_t ptr, const double bit, vvp_context_t) {
    dispatch_operand_(ptr, bit);
...
void vvp_cmp_ne_real::recv_real(vvp_net_ptr_t ptr, const double bit, vvp_context_t) {
    dispatch_operand_(ptr, bit);
...
void vvp_cmp_ge_real::recv_real(vvp_net_ptr_t ptr, const double bit, vvp_context_t) {
    dispatch_operand_(ptr, bit);
...
void vvp_cmp_gt_real::recv_real(vvp_net_ptr_t ptr, const double bit, vvp_context_t) {
    dispatch_operand_(ptr, bit);
