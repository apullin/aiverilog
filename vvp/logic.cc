...
void vvp_fun_boolean_::recv_vec4(vvp_net_ptr_t ptr, const vvp_vector4_t& bit, vvp_context_t) {
...
void vvp_fun_boolean_::recv_vec4_pv(
...
void vvp_fun_boolean_::recv_real(vvp_net_ptr_t ptr, double real, vvp_context_t ctx) {
    recv_vec4(ptr, double_to_vector4_LSB(real), ctx);
}

vvp_fun_and::vvp_fun_and(unsigned wid, bool invert) : vvp_fun_boolean_(wid), invert_(invert) {
...
vvp_fun_equiv::vvp_fun_equiv() : vvp_fun_boolean_(1) {
    count_functors_logic += 1;
}
...
vvp_fun_impl::vvp_fun_impl() : vvp_fun_boolean_(1) {
    count_functors_logic += 1;
}
...
vvp_fun_buf_not_::vvp_fun_buf_not_(unsigned wid) : input_(wid, BIT4_Z) {
    net_ = 0;
}

vvp_fun_buf_not_::~vvp_fun_buf_not_() {}

void vvp_fun_buf_not_::recv_vec4(vvp_net_ptr_t ptr, const vvp_vector4_t& bit, vvp_context_t) {
    if (ptr.port() != 0)
        return;
...
void vvp_fun_buf_not_::recv_vec4_pv(
    vvp_net_ptr_t ptr, const vvp_vector4_t& bit, unsigned base, unsigned vwid, vvp_context_t) {
    if (ptr.port() != 0)
        return;
...
void vvp_fun_buf_not_::recv_real(vvp_net_ptr_t ptr, double real, vvp_context_t ctx) {
    if (ptr.port() != 0)
        return;
...
vvp_fun_buf::vvp_fun_buf(unsigned wid) : vvp_fun_buf_not_(wid) {
    count_functors_logic += 1;
}
 ...
 */
void vvp_fun_bufz::recv_vec4(vvp_net_ptr_t ptr, const vvp_vector4_t& bit, vvp_context_t) {
    if (ptr.port() != 0)
        return;
...
void vvp_fun_bufz::recv_vec4_pv(
    vvp_net_ptr_t ptr, const vvp_vector4_t& bit, unsigned base, unsigned vwid, vvp_context_t) {
    if (ptr.port() != 0)
        return;
...
void vvp_fun_muxr::recv_vec4(vvp_net_ptr_t ptr, const vvp_vector4_t& bit, vvp_context_t) {
...
void vvp_fun_muxz::recv_vec4(vvp_net_ptr_t ptr, const vvp_vector4_t& bit, vvp_context_t) {
    switch (ptr.port()) {
        case 0:
...
void vvp_fun_muxz::recv_vec4_pv(
    vvp_net_ptr_t ptr, const vvp_vector4_t& bit, unsigned base, unsigned vwid, vvp_context_t) {
    assert(base + bit.size() <= vwid);
    bool flag;
...
vvp_fun_not::vvp_fun_not(unsigned wid) : vvp_fun_buf_not_(wid) {
    count_functors_logic += 1;
}
...
vvp_fun_or::vvp_fun_or(unsigned wid, bool invert) : vvp_fun_boolean_(wid), invert_(invert) {
    count_functors_logic += 1;
}
...
vvp_fun_xor::vvp_fun_xor(unsigned wid, bool invert) : vvp_fun_boolean_(wid), invert_(invert) {
    count_functors_logic += 1;
}
...
void compile_functor(char* label,
                     char* type,
                     unsigned width,
                     unsigned ostr0,
                     unsigned ostr1,
