...
class vvp_arith_abs : public vvp_net_fun_t {
  public:
    ...
    void recv_vec4(vvp_net_ptr_t ptr, const vvp_vector4_t& bit, vvp_context_t) override;
    void recv_real(vvp_net_ptr_t ptr, double bit, vvp_context_t) override;
...
class vvp_cmp_gtge_base_ : public vvp_arith_ {
  ...
  protected:
    void recv_vec4_base_(vvp_net_ptr_t ptr, const vvp_vector4_t& bit, vvp_bit4_t out_if_equal);
...
class vvp_arith_sub : public vvp_arith_ {
  public:
    ...
    virtual void recv_vec4(vvp_net_ptr_t port, const vvp_vector4_t& bit, vvp_context_t) override;
};
...
class vvp_cmp_eq_real : public vvp_arith_real_ {
  public:
    ...
    void recv_real(vvp_net_ptr_t ptr, const double bit, vvp_context_t) override;
};
