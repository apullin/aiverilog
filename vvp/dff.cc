...
vvp_dff_aclr::vvp_dff_aclr(unsigned width, bool negedge) : vvp_dff(width, negedge) {}

vvp_dff_aset::vvp_dff_aset(unsigned width, bool negedge) : vvp_dff(width, negedge) {}
...
void vvp_dff::recv_vec4(vvp_net_ptr_t port, const vvp_vector4_t& bit, vvp_context_t) {
    vvp_bit4_t tmp;
...
void compile_dff_aclr(char* label,
                      unsigned width,
                      bool negedge,
                      struct symb_s arg_d,
                      struct symb_s arg_c,
...
void compile_dff_aset(char* label,
                      unsigned width,
                      bool negedge,
                      struct symb_s arg_d,
                      struct symb_s arg_c,
