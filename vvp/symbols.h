...
class symbol_table_s {
  ...
  private:
    ...
    symbol_value_t
    find_value_(struct tree_node_* cur, const char* key, symbol_value_t val, bool force_flag);
 ...
 */
inline symbol_table_t new_symbol_table(void) {
    return new symbol_table_s;
}
inline void delete_symbol_table(symbol_table_t tbl) {
    delete tbl;
}
