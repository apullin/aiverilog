...
void vvp_latch::recv_vec4(vvp_net_ptr_t port, const vvp_vector4_t& bit, vvp_context_t) {
    vvp_bit4_t tmp;
...
void compile_latch(char* label, unsigned width, struct symb_s arg_d, struct symb_s arg_e) {
