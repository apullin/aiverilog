...
class vvp_reduce_base : public vvp_net_fun_t {
  public:
    ...
    void recv_vec4(vvp_net_ptr_t prt, const vvp_vector4_t& bit, vvp_context_t context) override;
...
void vvp_reduce_base::recv_vec4(vvp_net_ptr_t prt,
                                const vvp_vector4_t& bit,
...
void vvp_reduce_base::recv_vec4_pv(vvp_net_ptr_t prt,
                                   const vvp_vector4_t& bit,
                                   unsigned base,
                                   unsigned vwid,
                                   vvp_context_t context) {
