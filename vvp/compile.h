 ...
 */
extern void wide_inputs_connect(vvp_wide_fun_core* core, unsigned argc, struct symb_s* argv);
 ...
 */
extern void compile_functor(char* label,
                            char* type,
                            unsigned width,
                            unsigned ostr0,
                            unsigned ostr1,
 ...
 */
extern void compile_resolver(char* label, char* type, unsigned argc, struct symb_s* argv);

extern void compile_concat(char* label,
                           unsigned w0,
                           unsigned w1,
                           unsigned w2,
                           unsigned w3,
...
extern void compile_concat8(char* label,
                            unsigned w0,
                            unsigned w1,
                            unsigned w2,
                            unsigned w3,
...
extern void compile_substitute(char* label,
                               unsigned width,
                               unsigned soff,
                               unsigned swidth,
                               unsigned argc,
 ...
 */
extern void compile_delay(char* label, unsigned width, vvp_delay_t* del, struct symb_s input);
extern void
compile_delay(char* label, unsigned width, unsigned argc, struct symb_s* argv, bool ignore_decay);

/*
 * This is called by the parser to create a part select node.
 * See the PART SELECT STATEMENT section in the README.txt
 */
extern void compile_part_select(char* label, char* src, unsigned base, unsigned wid);
extern void
compile_part_select_pv(char* label, char* src, unsigned base, unsigned wid, unsigned vec_wid);
extern void
compile_part_select_var(char* label, char* src, char* var, unsigned wid, bool is_signed);
 ...
 */
extern void
compile_arith_pow(char* label, long width, bool signed_flag, unsigned argc, struct symb_s* argv);
extern void compile_arith_abs(char* label, unsigned argc, struct symb_s* argv);
extern void compile_arith_cast_int(char* label, long width, unsigned argc, struct symb_s* argv);
extern void
compile_arith_cast_real(char* label, bool signed_flag, unsigned argc, struct symb_s* argv);
extern void compile_arith_cast_vec2(char* label, long width, unsigned argc, struct symb_s* argv);
extern void
compile_arith_div(char* label, long width, bool signed_flag, unsigned argc, struct symb_s* argv);
extern void
compile_arith_mod(char* label, long width, bool signed_flag, unsigned argc, struct symb_s* argv);
extern void compile_arith_mult(char* label, long width, unsigned argc, struct symb_s* argv);
extern void compile_arith_sum(char* label, long width, unsigned argc, struct symb_s* argv);
extern void compile_arith_sub(char* label, long width, unsigned argc, struct symb_s* argv);
extern void compile_cmp_eeq(char* label, long width, unsigned argc, struct symb_s* argv);
extern void compile_cmp_nee(char* label, long width, unsigned argc, struct symb_s* argv);
extern void compile_cmp_eq(char* label, long width, unsigned argc, struct symb_s* argv);
extern void compile_cmp_eqx(char* label, long width, unsigned argc, struct symb_s* argv);
extern void compile_cmp_eqz(char* label, long width, unsigned argc, struct symb_s* argv);
extern void compile_cmp_ne(char* label, long width, unsigned argc, struct symb_s* argv);
extern void
compile_cmp_ge(char* label, long width, bool signed_flag, unsigned argc, struct symb_s* argv);
extern void
compile_cmp_gt(char* label, long width, bool signed_flag, unsigned argc, struct symb_s* argv);
extern void compile_cmp_weq(char* label, long width, unsigned argc, struct symb_s* argv);
extern void compile_cmp_wne(char* label, long width, unsigned argc, struct symb_s* argv);

extern void compile_arith_mult_r(char* label, unsigned argc, struct symb_s* argv);
...
extern void compile_latch(char* label, unsigned width, struct symb_s arg_d, struct symb_s arg_e);

extern void
compile_enum2_type(char* label, long width, bool signed_flag, std::list<struct enum_name_s>* names);
extern void
compile_enum4_type(char* label, long width, bool signed_flag, std::list<struct enum_name_s>* names);

struct __vpiModPath;
extern __vpiModPath*
compile_modpath(char* label, unsigned width, struct symb_s drv, struct symb_s dest);
...
extern void compile_sfunc(char* label,
                          char* name,
                          char* format_string,
                          long file_idx,
                          long lineno,
...
extern void compile_repeat(char* label, long width, long repeat, struct symb_s arg);

extern void compile_shiftl(char* label, long width, unsigned argc, struct symb_s* argv);
extern void
compile_shiftr(char* label, long width, bool signed_flag, unsigned argc, struct symb_s* argv);
...
extern void compile_param_string(
    char* label, const char* name, char* value, bool local_flag, long file_idx, long lineno);
extern void compile_param_logic(char* label,
                                const char* name,
                                char* value,
                                bool signed_flag,
                                bool local_flag,
                                long file_idx,
                                long lineno);
extern void compile_param_real(
    char* label, const char* name, char* value, bool local_flag, long file_idx, long lineno);
...
extern void
compile_udp_def(int sequ, char* label, char* name, unsigned nin, unsigned init, char** table);

extern void compile_udp_functor(char* label, char* type, unsigned argc, struct symb_s* argv);
...
extern void
compile_var_array(char* label, char* name, int last, int first, int msb, int lsb, char signed_flag);
extern void compile_var2_array(
    char* label, char* name, int last, int first, int msb, int lsb, bool signed_flag);
 ...
 */
extern void compile_ufunc_real(char* label,
                               char* code,
                               unsigned wid,
                               unsigned argc,
                               struct symb_s* argv,
                               ...
                               char* scope_label,
                               char* trigger_label);
extern void compile_ufunc_vec4(char* label,
                               char* code,
                               unsigned wid,
                               unsigned argc,
                               struct symb_s* argv,
 ...
 * the threads.
 */
extern void compile_event(char* label, char* type, unsigned argc, struct symb_s* argv);
...
extern void compile_file_line(char* label, long file_idx, long lineno, char* description);

extern void compile_vpi_call(char* label,
                             char* name,
...
extern void compile_vpi_func_call(char* label,
                                  char* name,
                                  int val_type,
                                  unsigned val_wid,
                                  long file_idx,
 ...
 */
extern void compile_scope_decl(char* typ,
                               char* lab,
                               char* nam,
                               char* tnam,
                               char* par,
...
extern void compile_port_info(
    unsigned index, int vpi_port_type, unsigned width, const char* name, char* buffer);
 ...
 */
extern void compile_net(char* label,
                        char* name,
                        int msb,
                        int lsb,
                        int vpi_type_code,
...
extern void compile_net_real(
    char* label, char* name, int msb, int lsb, bool local_flag, unsigned argc, struct symb_s* argv);

extern void compile_netw(char* label,
                         char* array_label,
...
extern void compile_netw_real(char* label,
                              char* array_symbol,
                              unsigned long array_addr,
                              int msb,
                              int lsb,
...
extern void
compile_island_tranif(int sense, char* island, char* ba, char* bb, char* src, bool resistive);
extern void compile_island_tranvp(
    char* island, char* ba, char* bb, unsigned width, unsigned part, unsigned off);
