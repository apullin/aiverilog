...
NetUDP::NetUDP(NetScope* s, perm_string n, unsigned pins, PUdp* u) : NetNode(s, n, pins), udp(u) {
...
bool NetUDP::next(string& inp, char& out) const {
    ...
    assert((out == '0') || (out == '1') || (out == 'x') || (is_sequential() && (out == '-')));
