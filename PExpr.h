...
class PExpr : public LineInfo {
  public:
    ...
    virtual NetExpr*
    elaborate_expr(Design* des, NetScope* scope, ivl_type_t type, unsigned flags) const;
    ...
    // be incomplete.
    virtual NetExpr*
    elaborate_expr(Design* des, NetScope* scope, unsigned expr_wid, unsigned flags) const;
    ...
    virtual NetAssign_* elaborate_lval(
        Design* des, NetScope* scope, bool is_cassign, bool is_force, bool is_init = false) const;
    ...
    virtual bool is_collapsible_net(Design* des, NetScope* scope, NetNet::PortType port_type) const;
...
class PEAssignPattern : public PExpr {
  public:
    ...
    virtual NetExpr*
    elaborate_expr(Design* des, NetScope* scope, ivl_type_t type, unsigned flags) const override;

    virtual NetExpr*
    elaborate_expr(Design* des, NetScope* scope, unsigned expr_wid, unsigned flags) const override;

  private:
    NetExpr* elaborate_expr_packed_(Design* des,
                                    NetScope* scope,
...
class PEConcat : public PExpr {
  public:
    ...
    virtual NetNet*
    elaborate_lnet(Design* des, NetScope* scope, bool var_allowed_in_sv) const override;
    virtual NetNet*
    elaborate_bi_net(Design* des, NetScope* scope, bool var_allowed_in_sv) const override;

    virtual NetExpr*
    elaborate_expr(Design* des, NetScope* scope, ivl_type_t type, unsigned flags) const override;

    virtual NetExpr*
    elaborate_expr(Design* des, NetScope*, unsigned expr_wid, unsigned flags) const override;
    ...
    virtual bool
    is_collapsible_net(Design* des, NetScope* scope, NetNet::PortType port_type) const override;

  private:
    NetNet* elaborate_lnet_common_(Design* des,
                                   NetScope* scope,
...
class PEFNumber : public PExpr {
  public:
    ...
    virtual unsigned test_width(Design* des, NetScope* scope, width_mode_t& mode) override;
    virtual NetExpr*
    elaborate_expr(Design* des, NetScope*, ivl_type_t type, unsigned flags) const override;
    virtual NetExpr*
    elaborate_expr(Design* des, NetScope*, unsigned expr_wid, unsigned flags) const override;
...
class PEIdent : public PExpr {
  public:
    ...
    const pform_scoped_name_t& path() const {
        return path_;
    }
  ...
  private:
    ...
    bool calculate_packed_indices_(Design* des,
                                   NetScope* scope,
                                   const NetNet* net,
  ...
  private:
    ...
    NetAssign_*
    elaborate_lval_array_(Design* des, NetScope* scope, bool is_force, NetNet* reg) const;
    NetAssign_* elaborate_lval_var_(Design* des,
                                    NetScope* scope,
                                    bool is_force,
                                    bool is_cassign,
                                    NetNet* reg,
                                    ivl_type_t data_type,
                                    pform_name_t tail_path) const;
    NetAssign_*
    elaborate_lval_net_word_(Design*, NetScope*, NetNet*, bool need_const_idx, bool is_force) const;
    bool elaborate_lval_net_bit_(
        Design*, NetScope*, NetAssign_*, bool need_const_idx, bool is_force) const;
    bool elaborate_lval_net_part_(Design*, NetScope*, NetAssign_*, bool is_force) const;
    bool elaborate_lval_net_idx_(Design*,
                                 NetScope*,
                                 NetAssign_*,
                                 index_component_t::ctype_t,
                                 bool need_const_idx,
                                 bool is_force) const;
    NetAssign_* elaborate_lval_net_class_member_(
        Design*, NetScope*, const netclass_t* class_type, NetNet*, pform_name_t) const;
    bool elaborate_lval_net_packed_member_(
        Design*, NetScope*, NetAssign_*, pform_name_t member_path, bool is_force) const;
    bool elaborate_lval_darray_bit_(Design*, NetScope*, NetAssign_*, bool is_force) const;

  private:
    NetExpr* elaborate_expr_(Design* des, NetScope* scope, unsigned expr_wid, unsigned flags) const;
    ...
    NetExpr* elaborate_expr_net_word_(Design* des,
                                      ...
                                      unsigned expr_wid,
                                      unsigned flags) const;
    NetExpr* elaborate_expr_net_part_(
        Design* des, NetScope* scope, NetESignal* net, NetScope* found, unsigned expr_wid) const;
    NetExpr* elaborate_expr_net_idx_up_(
        Design* des, NetScope* scope, NetESignal* net, NetScope* found, bool need_const) const;
    NetExpr* elaborate_expr_net_idx_do_(
        Design* des, NetScope* scope, NetESignal* net, NetScope* found, bool need_const) const;
    NetExpr* elaborate_expr_net_bit_(
        Design* des, NetScope* scope, NetESignal* net, NetScope* found, bool need_const) const;
    NetExpr* elaborate_expr_net_bit_last_(
        Design* des, NetScope* scope, NetESignal* net, NetScope* found, bool need_const) const;

    NetExpr* elaborate_expr_class_field_(Design* des,
                                         NetScope* scope,
    ...
    ivl_type_t
    resolve_type_(Design* des, const symbol_search_results& sr, unsigned int& index_depth) const;
  ...
  private:
    ...
    bool eval_part_select_(
        Design* des, NetScope* scope, const NetNet* sig, long& midx, long& lidx) const;
};
...
class PENewClass : public PExpr {
  public:
    ...
    explicit PENewClass(const std::list<named_pexpr_t>& p, data_type_t* class_type = nullptr);
  ...
  private:
    NetExpr* elaborate_expr_constructor_(
...
class PENumber : public PExpr {
  public:
    ...
    elaborate_expr(Design* des, NetScope* scope, ivl_type_t type, unsigned flags) const override;
    virtual NetEConst*
    elaborate_expr(Design* des, NetScope*, unsigned expr_wid, unsigned) const override;
    virtual NetAssign_* elaborate_lval(Design* des,
                                       NetScope* scope,
                                       bool is_cassign,
                                       bool is_force,
...
class PETypename : public PExpr {
  public:
    ...
    inline data_type_t* get_type() const {
        return data_type_;
    }
...
class PEBinary : public PExpr {
  ...
  protected:
    ...
    NetExpr* elaborate_expr_base_(Design*, NetExpr* lp, NetExpr* rp, unsigned expr_wid) const;
    NetExpr* elaborate_eval_expr_base_(Design*, NetExpr* lp, NetExpr* rp, unsigned expr_wid) const;

    NetExpr* elaborate_expr_base_bits_(Design*, NetExpr* lp, NetExpr* rp, unsigned expr_wid) const;
    NetExpr* elaborate_expr_base_div_(Design*, NetExpr* lp, NetExpr* rp, unsigned expr_wid) const;
    NetExpr* elaborate_expr_base_mult_(Design*, NetExpr* lp, NetExpr* rp, unsigned expr_wid) const;
    NetExpr* elaborate_expr_base_add_(Design*, NetExpr* lp, NetExpr* rp, unsigned expr_wid) const;
};
...
class PEBLeftWidth : public PEBinary {
  public:
    ...
    virtual NetExpr*
    elaborate_expr_leaf(Design* des, NetExpr* lp, NetExpr* rp, unsigned expr_wid) const = 0;
...
class PEBPower : public PEBLeftWidth {
  public:
    ...
    NetExpr*
    elaborate_expr_leaf(Design* des, NetExpr* lp, NetExpr* rp, unsigned expr_wid) const override;
};
...
class PETernary : public PExpr {
  ...
  private:
    NetExpr* elab_and_eval_alternative_(Design* des,
                                        NetScope* scope,
                                        PExpr* expr,
                                        unsigned expr_wid,
                                        unsigned flags,
...
class PECallFunction : public PExpr {
  public:
    ...
    explicit PECallFunction(PPackage* pkg,
                            const pform_name_t& n,
  ...
  private:
    ...
    NetExpr* elaborate_expr_(Design* des, NetScope* scope, unsigned flags) const;

    NetExpr* elaborate_expr_method_(Design* des,
                                    NetScope* scope,
                                    symbol_search_results& search_results) const;
    NetExpr* elaborate_expr_method_par_(Design* des,
                                        const NetScope* scope,
                                        const symbol_search_results& search_results) const;


    NetExpr*
    elaborate_sfunc_(Design* des, NetScope* scope, unsigned expr_wid, unsigned flags) const;
    ...
    unsigned test_width_method_(Design* des,
                                NetScope* scope,
                                const symbol_search_results& search_results,
                                width_mode_t& mode);

    NetExpr* elaborate_base_(Design* des, NetScope* scope, NetScope* dscope, unsigned flags) const;

    unsigned elaborate_arguments_(Design* des,
                                  NetScope* scope,
